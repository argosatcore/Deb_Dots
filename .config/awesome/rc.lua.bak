...
--Library needed to create widgets
...
beautiful.init("~/.config/awesome/dafultthemes/zenburn/theme.lua")
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.maximized("~/Pictures/Wallpapers/tile.jpeg", s, true)
    end
end
