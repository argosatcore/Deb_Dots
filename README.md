...
1. In order to bootstrap this dot files, install and use `wget` to download the bootstrapping script called `waystrap.sh`(it is located inside the `Debstrap` folder in this repository).
