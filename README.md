...
This dot files were started on a Debian mininall install, but should work with any Debian installation or Debian based distribution. Feel free to take them as a departure point for your own dot files.
