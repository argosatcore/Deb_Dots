...
- `Caps Lock key is swapped with Esc key`: Caps Lock has way too much of a good position for the function it provides. If you are a vim user (or someone that just uses the crap out of the Esc key), you how handy this is. If you don't want this, just delete the ".speedswapper" file.
